            ...
            <div className=" flex items-center justify-center  font-inter">
                <div className='w-[60%] h-[70%]  flex my-20'>
                    <div className="grow-[1]">
                        <h1 className="font-extrabold tracking-wider text-[#4832D3]">Skills</h1>
                    </div>
