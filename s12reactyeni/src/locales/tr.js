export default {
    baslik: 'Ben bir Frontend \nYazılımcıyım...',
    metin2: "...sağlam ve ölçeklenebilir frontend ürünleri\noluşturabilirim, harika kullanıcı deneyimleri\nsunabilirim.",
    yetenek:"Yetenekler",
    profil:"Profil",
    bilgiler:"Bilgiler",
    dogum:"Doğum Tarihi",
    ...
    rol:"Tercih Ettiği\nRol",
    hakkimda:"Hakkımda",
    metin3:"1994 yılında Trabzon'da doğdum.\n3.5 yıllık bir iş deneyimi sonunda tutkunu\n olduğum yazılım hayatına atıldım.",
    metin4:"Workintech ile beraber çeşitli yazılım\ndillerinde ve frameworklerinde uzmanlaştım.\nHedefim devamlı güncel olmak ve geliştirmeye\n devam etmek.",
    proje:"Projeler",
